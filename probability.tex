...
The second one — working backwards from results to reasons, purely, inferential — is what Bayes’ Theorem is all about. It’s how we reconstruct from data the underlaying phenomenology.\\
...
Here’s the rule in its mathematical form. The probability of obtaining some result, or evidence $E$, given some prior hypothesis $H$ was true:
