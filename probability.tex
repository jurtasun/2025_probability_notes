...
Let us define two vectors in \( \mathbb{R}^3 \) as column vectors:
\[
...
The cross product (or vector product), defined only in three dimensions, yields a vector orthogonal to both \( \mathbf{v}_1 \) and \( \mathbf{v}_2 \):
\[
