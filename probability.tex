...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chapter2/binomial_1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chapter2/binomial_2.png}
    \caption{Representation of the binomial distribution of a random variable $x$, given the total number of trials $n$ and the individual probability of success $p$.}
    \label{fig:binomial1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chapter2/binomial_1_cum.png}
    \caption{Representation of the binomial distribution of a random variable $x$, given the total number of trials $n$ and the individual probability of success $p$.}
    \label{fig:binomial1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chapter2/binomial_2_cum.png}
    \caption{Representation of the binomial distribution of a random variable $x$, given the total number of trials $n$ and the individual probability of success $p$.}
    \label{fig:binomial1}
\end{figure}
