...
Both probability as a predictive brach mathematics, and inferential - or descriptive - statistics, have deep historical roots. Indeed, nowadays they have become even trendy, given the broad set of fields dealing with data analysis. As one could guess, there are endless resources covering almost anything, rivers of ink have been written about such topics. However, after following many different courses at both bachelor and postgrad levels, and teaching such topics myself during almost three years, I have found that most resources belong, almost certainly, to one of the next three classes. Either ($i$) deeply mathematical, and hence out of reach for most of experimental or clinically oriented scientists, ($ii$) laboratory oriented, focusing on descriptive stats and experimental design, and hence missing most - if not all - of the mathematical definitions that enable simple computations, or ($iii$) with a direct focus towards programming and computation, relying on domain specific notebooks (Python, R, Matlab, SPSS, etc), and online resources with precompiled libraries for simulation, and again missing most of the mathematical and formal intuitions. Indeed, the misuse of statistics in experimental sciences is a patent topic in modern times, as mathematicians have extensively discussed during the last decades. The famous article by Ionnadis, \textit{"Why 90\% of published medical research is plain wrong"}, is just one example [...], and it may serve as motivation for a rigorous study.\\

At this point I would like to challenge the reader for a second. I guess you may have heard already some intuition about concepts such as stochasticity, sampling, Gaussian, standard error, maybe statistic test, hypothesis, significance, p-value, etc. Most likely these terms are already somehow familiar, and you find them frequently used on your respective field. Meanwhile - and again, this is just a guess - they were rarely introduced or properly defined. Indeed, for most scientific or experimental bachelor degrees, they are note explained or introduced at all. Hence, developing high-quality, simple, engaging and accessible material for present and future generations, covering both probability and statistical inference from both a fundamental \textit{and} applied level, remains one of the urgent tasks of scientists and educators.\\
...
It was not until the late medieval and early Renaissance periods that more rigorous ideas began to emerge. Mathematicians such as Gerolamo Cardano (1501–1576) made foundational contributions to the mathematical treatment of chance by analyzing gambling problems and developing early probabilistic reasoning. In such times, the idea of information and chance was not formalized as we know it today, and lacked mathematical language and rigour we will use in the present manuscript. If one goes to the original works of Cardano to grasp how was it to think and work in probability at such times, he will find a rather ambiguous symbolic system as the one depicted in figure [...].\\
