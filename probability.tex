...
\begin{figure}[ht]
    ...
    \caption{Histogram representing the mean and standard deviation for a set of Binomial observations [...]. The read line shows the mean value, representing the central value where the bulk of events lie, and the dotted lines show the standard deviation, as measure of the variability, or how spread the observations are with respect to the mean.}
...
\begin{figure}[ht]
    ...
    \caption{Histogram representing the mean and standard deviation for a set of Poisson observations [...]. The read line shows the mean value, representing the central value where the bulk of events lie, and the dotted lines show the standard deviation, as measure of the variability, or how spread the observations are with respect to the mean.}
    \label{fig:histogram1}
\end{figure}
